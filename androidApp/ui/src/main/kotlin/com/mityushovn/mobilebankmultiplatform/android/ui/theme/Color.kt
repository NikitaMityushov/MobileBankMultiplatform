...
val bankLightColors = BankColors(
    ...
    contentAccentTertiary = Color(Constants.LightColors.contentAccentTertiary),
    ...
    bgBottomMenu = Color(Constants.LightColors.bgBottomMenu),
    scrimer = Color(Constants.LightColors.scrimer),
    calendarPeriod = Color(Constants.LightColors.calendarPeriod),
...
val bankDarkColors = BankColors(
    ...
    bgBottomMenu = Color(Constants.DarkColors.bgBottomMenu),
    scrimer = Color(Constants.DarkColors.scrimer),
    calendarPeriod = Color(Constants.DarkColors.calendarPeriod),
